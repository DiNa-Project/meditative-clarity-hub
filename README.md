...
- **Meditation**: main circular button plays `assets/body_scan.mp3`.
- **Practice mode**: bottom-left mini button plays `assets/body_scan_try.mp3` and opens the questionnaire without storing/syncing data.
